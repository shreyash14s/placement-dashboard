...
foreach ($emails as $email) {
	...
	$message = Swift_Message::newInstance('PES Placement Hub - ')
	  ...
	  ->setTo(array($email))
	  ->setBody('Welcome to PES Placement Portal'.PHP_EOL.'Dear student,'.PHP_EOL."New companies have been added to the portal recently. Login at http://localhost:8080 to register!".PHP_EOL.PHP_EOL."Regards,".PHP_EOL."Team Placement Hub");
